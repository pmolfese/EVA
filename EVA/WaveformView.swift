...
struct WaveformView: View {
    ...
    @State var waveletExplorerStatusTitle = ""
    @State var waveletExplorerStatusDetail = ""
    @State var waveletExplorerStatusMessage: String?
    @State var waveletExplorerLog: [WaveletArtifactExplorerLogLine] = []
    @State var waveletExplorerResult: WaveletArtifactExplorerResult?
    @State var waveletExplorerRunGeneration = 0
    @State var waveletExplorerPipeline = WaveletCleaningPipeline.eeg
    @State var waveletExplorerCleaningMode = WaveletCleaningMode.conservativeLocal
    @State var waveletExplorerIntensity = WaveletCleaningMode.conservativeLocal.defaultIntensity
    @State var waveletExplorerChannelScope = WaveletExplorerChannelScope.visibleGood
    @State var waveletExplorerDownsampleRate = 250.0
    @State var waveletExplorerLevelCount = 8
    @State var waveletExplorerThresholdScale = 1.0
    @State var waveletExplorerWaveletFamily = WaveletCleaningFamily.bior44
    @State var waveletExplorerThresholdRule = WaveletCleaningThresholdRule.hard
    @State var waveletExplorerThresholdModel = WaveletCleaningThresholdModel.bayesShrink
    @State var waveletExplorerMergeWindowSeconds = 0.10
    @State var waveletExplorerMinimumDurationSeconds = 0.02
