...
for name in eva-wica-ica-algorithms.csv eva-wica-ica-algorithms.md; do
...
echo "Results:"
echo "  $DESTINATION/eva-wica-ica-algorithms.md"
echo "  $DESTINATION/eva-wica-ica-algorithms.csv"
run cat "$DESTINATION/eva-wica-ica-algorithms.md"
