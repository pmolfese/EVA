...
for name in eva-wica-density-baseline.csv eva-wica-density-baseline.md \
    eva-wica-density-routing.csv eva-wica-density-routing.md; do
...
echo "Results:"
echo "  $DESTINATION/eva-wica-density-baseline.md"
echo "  $DESTINATION/eva-wica-density-baseline.csv"
echo "  $DESTINATION/eva-wica-density-routing.md"
echo "  $DESTINATION/eva-wica-density-routing.csv"
run cat "$DESTINATION/eva-wica-density-baseline.md"
run cat "$DESTINATION/eva-wica-density-routing.md"
